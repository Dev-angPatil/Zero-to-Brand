        ...
        {products.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((prod) => (
              <div
                key={prod.id}
                className="bg-white/40 backdrop-blur-md rounded-[24px] overflow-hidden border border-current/15 shadow-sm flex flex-col h-full hover:-translate-y-1 hover:shadow-md transition-all duration-300"
              >
                {/* Visual Banner */}
                <div className="h-56 relative overflow-hidden bg-white/5 border-b border-current/5">
                  <img
                    ...
                    alt={prod.name}
                    className="w-full h-full object-cover saturate-[0.9] hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute bottom-3 left-3 px-3 py-1 bg-black/45 text-white rounded-full text-[9px] font-mono tracking-widest uppercase shadow-sm">
                    Craft Batch
                  </div>
                </div>
                ...
                <div className="p-6 flex-grow flex flex-col gap-3 justify-between">
                  <div className="flex flex-col gap-2">
                    ...
                    <h3 className="text-xl font-bold uppercase tracking-wider font-headline">{prod.name}</h3>
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {prod.materials.map((m, idx) => (
                          <span key={idx} className="px-2.5 py-0.5 bg-current/5 border border-current/5 text-current rounded-full text-[9px] font-bold">
                            {m}
                          </span>
                        ))}
                      </div>
